...
let opt_f1_iteration_limit = ref 1000000000000L
let opt_iteration_limit_enforced = ref None
let opt_f2_iteration_limit_enforced = ref None
let opt_f1_iteration_limit_enforced = ref None
...
let opt_trace_struct_adapter = ref false
...
let opt_disqualify_path_on_ret_addr_overwrite = ref false
let opt_stdin_replay_file_target_frag_offset = ref 0
let opt_trace_repair = ref false
let opt_restrict_reads_to_N_bytes = ref (-1)
...
let opt_synth_adapter = ref []
let opt_synth_repair_adapter = ref None
let opt_synth_ret_adapter = ref []
let opt_synth_repair_ret_adapter = ref None
let opt_synth_struct_adapter = ref []
let opt_struct_adapter_params = ref (0,0,0)
let opt_adapter_search_mode  = ref false
let opt_adapter_ivc = ref false
let opt_split_target_formulas = ref false
let opt_synth_simplelen_adapter = ref []
...
let opt_disqualify_path_on_nonfalse_cond = ref false
let opt_finish_immediately = ref false
...
let synth_verify_adapter = ref false
let stdin_replay_fd = ref None 
